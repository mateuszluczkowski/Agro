...
$(document).on('scroll', function () {
    ...
    if ($(document).scrollTop() > topDistanceArt2 + heightArt2 - $(window).height()) {
        $('article:nth-of-type(2)').addClass('active')
    }

    if ($(document).scrollTop() > topDistanceArt3 + heightArt3 / 2 - $(window).height()) {
        $('article:nth-of-type(3)').addClass('active')
    }
    if ($(document).scrollTop() > topDistanceArt4 + heightArt4 - $(window).height()) {
